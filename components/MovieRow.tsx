...
const params =useSearchParams()
  ...
  return (
    ...
    <h1 className='font-bold text-2xl lg:text-5xl p-4 capitalize'>
    ...
    {pathname=='/' && <button 
      ...
      <div
       ref={scrollRef}
      className={`h-fit overflow-x-scroll scroll-smooth scrollbar-hide lg:w-[79%]  ${pathname=='/' && "w-[95%]  whitespace-nowrap" }`}>
